...
$db->query("ALTER TABLE plg_tickets_settings ADD column ticket_view varchar(255) default 'support/tickets.php'");
$db->query("ALTER TABLE plg_tickets_settings ADD column single_view varchar(255) default 'support/ticket.php'");
if($check < 1){
